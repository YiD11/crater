...
| backendConfig.schedulerExtenderPort | string | `":8089"` | Network port serving volcano's scheduler extender callbacks (Optional) Unset deploys without the endpoint; when set it must match extender.urlPrefix in the volcano configmap |
